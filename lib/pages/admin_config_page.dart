...
/// Admin configuration page for full user data schema manipulation
/// Dynamically renders UI based on the schema definition
/// Provides complete access to all user data fields for administrators
...
class _AdminConfigPageState extends State<AdminConfigPage> {
  ...
  void initState() {
    ...
    try {
      ...
      debugPrint('Error in AdminConfigPage initState: $e');
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Full user data schema configuration',
                style: TextStyle(

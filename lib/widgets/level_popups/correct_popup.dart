...
class CorrectLevelPopup {
  ...
  static Future<void> show(BuildContext context) {
    ...
    final popupHeight = styles.getStyles('module_pages.level_popups.correct_popup.height') as double;
    final iconPath = styles.getStyles('module_pages.level_popups.correct_popup.icon') as String;
    ...
    final continueButtonBackground = styles.getStyles('module_pages.level_popups.correct_popup.continue_button.background_color') as Color;
    final continueButtonStroke = styles.getStyles('module_pages.level_popups.correct_popup.continue_button.stroke_color') as LinearGradient;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(builder: (ctx) {
                        ...
                        return Text('Correct', style: base.copyWith(fontSize: titleFontSize, color: titleColor, fontWeight: titleFontWeight));
                      }),
                      ...
                      Builder(builder: (ctx) {
                        ...
                        return Text('Great job!', style: base.copyWith(fontSize: subtitleFontSize, color: subtitleColor, fontWeight: subtitleFontWeight));
                      }),
                      const SizedBox(height: 8),

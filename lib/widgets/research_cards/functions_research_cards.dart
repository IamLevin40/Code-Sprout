...
class FunctionsResearchCards extends StatelessWidget {
  ...
  Widget _buildFunctionsCard(FunctionsResearchItemSchema item, FunctionsResearchState state) {
    ...
    // Functions-specific styles
    final nameColor = styles.getStyles('research_card.functions_item.name.color') as Color;
    final nameSize = styles.getStyles('research_card.functions_item.name.font_size') as double;
    final nameWeight = styles.getStyles('research_card.functions_item.name.font_weight') as FontWeight;

    final descColor = styles.getStyles('research_card.functions_item.description.color') as Color;
    final descSize = styles.getStyles('research_card.functions_item.description.font_size') as double;
    final descWeight = styles.getStyles('research_card.functions_item.description.font_weight') as FontWeight;
